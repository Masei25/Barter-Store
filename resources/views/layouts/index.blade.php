...
<html>
<head>
<title>Barter Store a Ecommerce Online Shopping Store | Home :: Barter</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			<div class="header-grid">
				<div class="header-grid-left animated wow slideInLeft" data-wow-delay=".5s">
					<ul>
						<li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">info@bater.com</a></li>
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1><a href="/">Barter Store <span>Shop anywhere</span></a></h1>
				</div>
